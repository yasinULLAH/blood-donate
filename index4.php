...
function seed_sample_data($db)
{
    try {
        ...
        $story_stmt->execute([
            ...
            1,
            'https://i.imgur.com/example_story3.jpg'
        ]);
        $story_stmt->execute([
            ...
            $user_ids[4],
            'https://i.imgur.com/example_story4.jpg'
        ]);
        ...
        $news_stmt->execute([
            ...
            1,
            'https://i.imgur.com/example_news3.jpg'
        ]);
        $news_stmt->execute([
            ...
            1,
            'https://i.imgur.com/example_news4.jpg'
        ]);
        $inventory_data = [
...
function handle_upload($file_input, $sub_dir, $allowed_extensions, $max_size = MAX_FILE_SIZE)
{
    ...
    if (move_uploaded_file($file_tmp_path, $dest_path)) {
        return 'uploads/' . $sub_dir . $new_file_name;
    } else {
